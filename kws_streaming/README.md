Note that this a fork of [Google's Research](https://github.com/google-research/google-research/tree/master/kws_streaming) with some modifications that enable running it on more modern versions of TensorFlow.
