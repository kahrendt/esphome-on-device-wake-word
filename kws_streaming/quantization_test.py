...
# model_non_stream = tf.keras.saving.load_model('/Users/kahrendt/Documents/Hobbies/Machine_Learning/wakeword_tflite/models1/cnn_1/non_stream', compile=False)
# # model_non_stream = tf.keras.saving.load_model('/Users/kahrendt/Documents/Hobbies/Machine_Learning/wakeword_tflite/models1/ds_tc_resnet_3/non_stream', compile=False)
# tf.keras.backend.set_learning_phase(0)
# input_data_shape = (1, 40) # 40 bins for micro model
...
#   model_inference = utils.convert_to_inference_model(model_non_stream,
#                                                 input_tensors, mode)
