...
#   model_config, created_layers = tf.keras.models.clone_layers_and_model_config(  # pylint:disable=protected-access,line-too-long
#       model, new_input_layers, tf.keras.models._clone_layer)
#   # pylint: enable=protected-access

#   # Reconstruct model from the config, using the cloned layers.
#   input_tensors, output_tensors, created_layers = (
#       tf.keras.engine.functional.reconstruct_from_config(  # pylint:disable=protected-access
